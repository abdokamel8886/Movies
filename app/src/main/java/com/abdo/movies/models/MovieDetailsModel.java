package com.abdo.movies.models;
...
public class MovieDetailsModel {
    ...
    private BelongsToCollectionDTO belongs_to_collection;
    private int budget;
    ...
    public BelongsToCollectionDTO getBelongs_to_collection() {
        return belongs_to_collection;
    }

    public void setBelongs_to_collection(BelongsToCollectionDTO belongs_to_collection) {
